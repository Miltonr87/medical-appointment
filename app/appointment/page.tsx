...
export default function Appointment() {
  const { currentStep, setCurrentStep } = useAppointmentStore();
    ...
    <div className="min-h-screen bg-background flex">
      ...
      <main className="flex-1 p-8 md:p-12 flex justify-center">
        <div className="w-full max-w-[878px]">
          ...
          {currentStep === 2 && <DoctorStep onContinue={handleContinue} onBack={handleBack} />}
          {currentStep === 3 && <PaymentStep onContinue={handleContinue} onBack={handleBack} />}
